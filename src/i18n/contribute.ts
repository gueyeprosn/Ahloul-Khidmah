...
const fr: ContributeDict = {
  ...
  form: {
    ...
    submit: "Continuer vers Wave / Orange Money",
    submitting: "Préparation du paiement…",
    note: "Après validation, choisissez Wave ou Orange Money (Max it) pour payer.",
    successTitle: "Merci pour votre soutien",
    successText:
      "Choisissez ci-dessous Wave ou Orange Money pour finaliser le paiement.",
...
const ar: ContributeDict = {
  ...
  form: {
    ...
    submit: "المتابعة إلى Wave / Orange Money",
    submitting: "جارٍ إعداد الدفع…",
    note: "بعد التأكيد، اختاروا Wave أو Orange Money (Max it) للدفع.",
    successTitle: "شكراً لدعمكم",
    successText: "اختاروا أدناه Wave أو Orange Money لإتمام الدفع.",
    payNow: "ادفع الآن",
